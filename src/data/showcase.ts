...
export const showcaseProjects: ShowcaseProject[] = [
  ...
  },
  {
    slug: 'grouper',
    name: 'Social Groups',
    packageId: 'com.linkjoiner.grouper',
    year: 2021,
    role: 'sole developer',
    client: 'Personal',
    ...
    description:
      'A WhatsApp group discovery app (android:label "Social Groups"). Users browse curated groups by category (Food, Funny, Sport, Travel, Education and more), open any group for its info and member count, and join in one tap. A community "Scammers" board lets people report and look up known scammers, and anyone can submit a new group or scammer entry with name, link and description. A companion admin app ("Grouper Admin") reviews and approves pending group/scammer submissions, manages categories, and configures the ad units remotely.',
    motive:
      'Make it easy to find trustworthy WhatsApp groups by interest while warning the community about known scammers.',
    techStack: ['Flutter', 'BLoC + HydratedBloc', 'Firebase (Firestore + Storage)', 'AdMob + AppLovin MAX', 'go_router'],
    features: [
      'Browse groups by category',
      'Group detail + one-tap join',
      'Community scammer board',
      'Submit a group or scammer (admin-approved)',
      'Companion admin: approve submissions, manage categories & ads',
      'Search',
    ],
    status: 'shipped',
  ...
  },
  {
    slug: 'bill-checker',
    name: 'Bill Checker',
    packageId: 'com.allbillchecker.pk',
    year: 2021,
    role: 'sole developer',
    client: 'Personal',
    category: 'Utility',
    ...
    techStack: ['Flutter', 'BLoC + HydratedBloc', 'webview_flutter', 'AdMob + AppLovin MAX', 'Firebase (Firestore)'],
    features: [
      'WAPDA / Gas / Phone / Water tabs',
      'All regional providers listed (LESCO, FESCO, SSGC, SNGPL, KE…)',
      'In-app provider bill portals (WebView)',
      'Light / dark theme',
      'Share / Privacy / Disclaimer',
    ],
    status: 'shipped',
    storeLink: 'https://play.google.com/store/apps/details?id=com.allbillchecker.pk',
    githubLink: null,
  ...
  },
  {
    ...
    description:
      'A social-rewards app where users earn WishCoin (WIS) — the app\'s in-platform reward token, presented as a BEP-20 coin — by liking, commenting, posting, spinning a fortune wheel and watching YouTube videos. A wallet tracks the WIS balance with backend-configured withdrawal methods and a full transaction history, and a referral/team system drives growth. Ships with a companion admin app ("Wish Admin") to manage posts, install-reward app listings, banner slides, videos, notifications, and the full user base with referral uplines.',
    motive:
      'Bridge a token-style reward economy with everyday social activity so anyone could earn WIS without any upfront investment.',
    techStack: ['Flutter', 'GetX + Provider', 'Firebase (Firestore + Storage)', 'REST API', 'youtube_player_flutter', 'flutter_fortune_wheel'],
    features: [
      'WishCoin (WIS) reward token',
      'Spin & Win',
      'Earn by like / comment / post / watch',
      'WIS wallet with configurable withdrawal methods',
      'Transaction history',
      'Referral / team uplines',
  ...
  },
  {
    ...
    description:
      'An HD wallpaper app featuring the biggest football stars — Ronaldo, Messi, Salah, De Bruyne, Lewandowski and more. Backed by a custom PHP API (fetched with Dio), users browse Recent / Popular / Clubs collections, see live download counts, then set, download, or share any wallpaper. Monetized with AdMob banners/interstitials plus Facebook Audience Network, with OneSignal push.',
    motive:
      'Give football fans a fast, curated source of high-quality player wallpapers while monetizing through ads.',
    techStack: ['Flutter', 'Provider', 'Custom PHP API + Dio', 'wallpaper_manager', 'cached_network_image', 'AdMob + FAN'],
    features: [
  ...
  {
    // Source verified: android:label "Egg Network", pkg com.luckyminer.eggnetwork. Primary
    // mechanic is passive "network mining" (not the spin/scratch/watch set the archive assumed);
    // there is no Watch & Earn. Renamed + re-mocked to match the real app.
    slug: 'egg-network',
    name: 'Egg Network',
    packageId: 'com.luckyminer.eggnetwork',
    year: 2023,
    role: 'sole developer',
    client: 'Client project',
    category: 'Rewards / Mining',
    tagline: 'Passive coin-mining app with spin, scratch & visit earns',
    description:
      'A rewards app built around passive "network mining" — users start an hourly mining session that accrues coins second-by-second, then top it up with a Spin & Win fortune wheel, Scratch & Win cards and Visit & Earn site tasks. Coins are cashed out through JazzCash, Easypaisa, UPI, Google Pay, Binance Pay or Paytm. Built on a BLoC + HydratedBloc architecture over Firebase, with AdMob + AppLovin MAX ad mediation and OneSignal push.',
    motive:
      'Borrow the "tap to mine / hatch" hook that makes Pi-style miners sticky, and pair it with quick casual earns and the local + crypto payout methods users actually use.',
    techStack: ['Flutter', 'BLoC + HydratedBloc', 'Firebase (Auth + Firestore)', 'flutter_fortune_wheel + scratcher', 'AdMob + AppLovin MAX', 'OneSignal'],
    features: [
      'Network Mining — hourly passive coin sessions',
      'Spin & Win prize wheel',
      'Scratch & Win cards',
      'Visit & Earn site tasks',
      'Mining portfolio & history',
    ...
    githubLink: null,
    screens: [
      'eggnetwork_home.avif',
      'eggnetwork_mining.avif',
      'eggnetwork_spin.avif',
      'eggnetwork_scratch.avif',
      'eggnetwork_visit.avif',
      'eggnetwork_withdraw.avif',
    ],
    featured: false,
  },
  {
  ...
  },
  {
    ...
    description:
      'A hostel-listing platform built as two companion apps over a Firebase Realtime Database. An admin app ("Hostel Admin", custom phone + password login) lets operators add hostel records — city, contact, hostel name, owner — capturing coordinates via geolocator. The public Hostel Finder app lets users search listings and tap straight through to Call the owner or open the Location in the device map launcher (Google/Apple Maps).',
    motive:
      'Help students find and contact nearby hostels quickly, while giving operators a simple way to publish and manage listings.',
    techStack: ['Flutter', 'GetX', 'Firebase Realtime DB', 'map_launcher', 'geolocator', 'url_launcher'],
    features: [
      'Separate admin & user apps',
      'Admin: add hostel records (city / contact / name / owner)',
      'Custom phone + password login',
      'Search hostels (live filter)',
      'One-tap Call & Location (map launcher)',
    ],
    status: 'shelved',
    storeLink: null,
    githubLink: null,
  ...
  },
  {
    ...
    description:
      'A dating/social app paired with an admin panel. Users build a profile with a public/private toggle, upload profile photos, and browse a grid of other profiles with in-app chat. The admin app lists every user, opens a detail sheet to review and block accounts (via the Firebase Admin SDK), and broadcasts push notifications by title and message.',
    motive:
    ...
    techStack: ['Flutter', 'Provider', 'Firebase Auth', 'Cloud Firestore', 'Firebase Storage', 'FCM + Admin SDK'],
    features: [
      'Profile with public/private visibility',
      'Profile photo upload',
      'Profile grid browsing',
      'In-app chat',
      'Admin: browse & block users (Firebase Admin SDK)',
      'Admin: broadcast push notifications (FCM)',
    ],
    status: 'shelved',
    storeLink: null,
    githubLink: null,
  ...
  },
  {
    ...
    description:
      'A connected breathalyzer ("borne éthylotest") companion deployed at venues across Europe. It is built around the AlcoPass C1 breathalyzer device — pairing over Bluetooth (universal_ble), parsing the C1\'s raw test data, and walking the user through the test phases (warm-up, blow, analyze) before refining a blood-alcohol estimate from age, weight, sex, driving-licence class and time since the last drink. Results come back in g/L of blood and mg/L of exhaled air, classified against the legal limit with a sober-up estimate, and are logged to Firestore. Built on Flutter + BLoC with go_router, localised in 5 languages (FR / EN / DE / ES / IT).',
    motive:
      'Give venues a turnkey self-test station so people can check whether they are over the limit before getting behind the wheel — backed by the real AlcoPass C1 breathalyzer hardware, not a guess.',
    techStack: ['Flutter', 'BLoC + HydratedBloc', 'universal_ble (AlcoPass C1)', 'Firebase (Firestore)', 'go_router', 'easy_localization (5 langs)'],
    features: [
      'Pairs with the AlcoPass C1 breathalyzer over BLE',
      'Parses the C1\'s raw data; guided warm-up → blow → analyze',
